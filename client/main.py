# Original code (c) the respective authors at Pimoroni.
import gc
import time
...
def launcher():
    ...
    graphics.set_pen(1)
    graphics.text("D. Work Agenda", 35, HEIGHT - (145 + y_offset), 600, 3)

    graphics.set_pen(0)
    graphics.rectangle(30, HEIGHT - (100 + y_offset), WIDTH - 300, 50)
    graphics.set_pen(1)
    graphics.text("E. Play Agenda", 35, HEIGHT - (85 + y_offset), 600, 3)
